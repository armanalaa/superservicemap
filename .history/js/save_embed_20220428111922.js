...
accessToken:accessToken
  ...
  function embedConfiguration() {
    ...
    var position = "#dialog";
    var dialog = "<div id='serviceMap_embed_dialog' title='Embed the ServiceMap' style='left: -10%;'><div id='serviceMap_info_title' >Embed your Service Map configuration<a id='sm_embed_close' title='Close'>X</a></div>";
