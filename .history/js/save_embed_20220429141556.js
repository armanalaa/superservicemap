  ...
  // var eventText= '';
   ...
   function save_handler(typeService, id, nameService, embed, textSearch) {
    ...
    if (save_operation == "write") {
      ...
      if(type=='address' ||type=='event' || type=='path' || (type=="Position_Bus" && selectedorgUrl==superServiceMapApiUrl) || (typeService=="weather" && selectedorgUrl==superServiceMapApiUrl) || (typeService=="weather" && selectedorgUrl==superServiceMapApiUrl)){
