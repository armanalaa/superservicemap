    ...
    if (save_operation == "write") {
      ...
      if(format=='json'){
        if(accessTokenMessage==false){
          ...
          dialog+="<span style='font-size: 10px;'>You can add \'&amp;accessToken=\' to update the results with private/delegated devices </span>";
          dialog+="</div>";
          dialog+="</div>";
          dialog+="</fieldset>";
          dialog+="</div>";
        ...
        if(accessTokenMessage==false){
          ...
          dialog+="<div>";
          dialog+="<div style=\"FLOAT: LEFT;\">";
          dialog+="<input type='button' id='copy_query_html' value='Copy' onclick='copy_query(\"query_link_html\");'>";
          dialog+="</div>";
          dialog+="<div style=\"left: 10px;position: relative;padding-right: 3px;\">";
          dialog+="<span style=\"color: red;font-weight:bold;font-size: 10px;\">note:</span>";
          dialog+="<span style='font-size: 10px;'>You can add \'&amp;accessToken=\' to update the results with private/delegated devices </span>";
