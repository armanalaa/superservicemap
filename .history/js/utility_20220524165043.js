...
function createContenutoPopup(feature, div, id) {
    ...
    $(document).ready(function () {
        ...
        //     var span_plus_nature = document.getElementById(nature_list[i] + '|nature_span');
        //     span_plus_nature.onclick = function () {
        //         nature_span_id = this.id;
        //         var nature = nature_list[i];
        //         subcategory_div_id = nature + '|subcategory_div';
        //         subcategory_div = document.getElementById(subcategory_div_id);

        //         span_plus_nature = document.getElementById(nature_span_id);
        //         span_plus_nature_text = span_plus_nature.textContent;

        //         if (span_plus_nature.innerHTML == '-') {
        //             span_plus_nature.innerHTML = '+';
...
function showVehiclePosition(zoom, agency, line){
    showVwhiclePositionButtonPressed=true;
    mostraAutobusRT(zoom, agency, line);
    showVwhiclePositionButtonPressed=false;
...
function mostraAutobusRT(zoom, agency, line) {
    ...
    if (!callingBusRT) {
        ...
        $.ajax({
            ...
            success: function (msg) {
                ...
                if(showVwhiclePositionButtonPressed==true && timer_position==true){
                if (msg.features.length > 0) {
    ...
    if(showPosition==true)
        currentBusRT = setTimeout(function () { mostraAutobusRT(undefined, agency, line) }, !line ? 160000 : 10000);
    }

function stopShowPositions(){
    currentPositionLayer.clearLayers();
    showPosition=false;
    timer_position=false;
}
