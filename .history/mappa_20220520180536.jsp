                    ...
                    <div id="tabs-1">
                        <div class="use-case-1">
                            ...
                            <div style="overflow: hidden; ">
                                <div id="pulsanteRT" name="autobusRealTime" onclick="mostraAutobusRT(true);" style="width: 185px;   float:left; border: 1px solid red;">
                                    <span id="vehicle_position" name="lbl" caption="Position_Bus">Show the asdasdasd of Vehicles</span>
                                </div>
                                <div id="stop_show_position" name="stop_show_position" onclick="stopShowPositions(true);">
                                <span name="lbl" caption="Stop_Show_Position" style="width: 290px;">sasda!</span>
                                </div>
                                </div>
                        </div>
                    </div>
